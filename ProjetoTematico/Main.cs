...
namespace ProjetoTematico
{
    ...
    { 
        GardenController _gardenController; private LoginDto _currentLogin;
        ...
        public Main(LoginDto _login)
        {
            ...
            _usuarioLogado = AutenticacaoController.GetById(_currentLogin.Id);

            _userController = new UserController(_usuarioLogado);
            _gardenController = new GardenController(_usuarioLogado);
            ...
            try
            {
                ...
                //Footer                   
                footerLabel.Text = $"Trabalhando no {_jardim.Name} - {DateTime.Now.ToString("d")}";
            }
            catch (Exception ex)
            {
                primeiroAcesso();
        ...
        private void plantaBtnMenuItem_Click(object sender, EventArgs e)
        {
            ...
            PlantForm plantForm = new PlantForm(_usuarioLogado)
            {
                TopLevel = false,
                Dock = DockStyle.Fill,
            };
        ...
        private void jardimBtnMenuItem_Click(object sender, EventArgs e)
        {
            ...
            GardenForm gardenForm = new GardenForm(_usuarioLogado)
            {
                TopLevel = false,
                Dock = DockStyle.Fill,
            };
        ...
        private void produtoBtnMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ProductForm gardenForm = new ProductForm(_usuarioLogado)
            {
                TopLevel = false,
                Dock = DockStyle.Fill,
            };
